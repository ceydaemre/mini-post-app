...
const { createPost, getAllPosts, deletePost, likePost, getPostById, updatePost, addComment, getCommentsByPostId, deleteComment, updateComment, likeComment} = require("../controllers/postController");
